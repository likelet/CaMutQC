...
* **Strand Bias score cutoff**: <span style="color:#ED6F3E">**`r SBscore`**</span>
...
**Maximum length of an indel**: <span style="color:#ED6F3E">**`r maxIndelLen`**</span>
...
**FILTER tag**: <span style="color:#ED6F3E">**`r tagFILTER`**</span>
