...
#' for filtering somatic mutations.
#'
...
fpfilter <- function(maf, bamcount_tumor = NULL, keep = TRUE, minReadPos = 0.1,
  ...
  if (is.null(bamcount_tumor)) {
    ...
    # traverse every line in maf_filter for potential filtering
    discard <- c()
