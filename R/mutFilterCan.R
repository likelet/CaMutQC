...
#' @param dbsnpCutoff Cutoff of normal depth for dbSNP variants. Default: 0.
#' @param nonCutoff Cutoff of normal depth for non-dbSNP variants. Default: 0.
...
mutFilterCan <- function(maf, cancerType, PONfile, PONformat = "vcf", 
                         ...
                         VAF = 0, VAFratio = 0, dbsnpCutoff = 0,
                         nonCutoff = 0, SBmethod = 'SOR',
  ...
  if (cancerType == 'BLCA'){
    mafFiltered <- mutFilterCom(maf, SBmethod='Fisher', SBscore=20,
                    ...
                    ExAC=TRUE, normalDP=10,tumorAD=5, VAF=VAF,normalAD=normalAD,
  ...
  # BRCA
    ...
    mafFiltered <- mutFilterCom(maf, tumorAD=5, VAF=0.1,
                    ...
                    keepCOSMIC=TRUE, tumorDP=6, normalDP=6,normalAD=normalAD, 
                    dbsnpCutoff=dbsnpCutoff, nonCutoff=nonCutoff,
  ...
  # COADREAD
    ...
    mafFiltered <- mutFilterCom(maf, tumorDP=5, VAF=0.2,
                    ...
                    SBmethod=SBmethod, SBscore=SBscore,normalAD=normalAD, 
                    dbsnpCutoff=dbsnpCutoff, nonCutoff=nonCutoff,
  ...
  # UCEC
    ...
    mafFiltered <- mutFilterCom(maf, dbSNP=TRUE, Genomesprojects1000=TRUE,
                     ...
                     SBscore=SBscore, maxIndelLen=maxIndelLen,
                     minInterval=minInterval, ExAC=ExAC,normalAD=normalAD,
                     tagFILTER=tagFILTER, dbVAF=dbVAF, ESP6500=ESP6500,
  ...
  # UCS
    ...
    mafFiltered <- mutFilterCom(maf, tumorAD=5, tumorDP=12, normalDP=5,
                                ...
                                VAF=VAF, VAFratio=VAFratio,normalAD=normalAD,
  ...
  # KIRC
    ...
    mafFiltered <- mutFilterCom(maf, dbSNP=TRUE,
                                Genomesprojects1000=Genomesprojects1000,
                                tumorDP=tumorDP, VAF=VAF,normalAD=normalAD,
                                dbsnpCutoff=dbsnpCutoff, nonCutoff=nonCutoff,
  ...
  # KIRP
    ...
    mafFiltered <- mutFilterCom(maf, tumorDP=8, normalDP=6, VAF=0.07,
                                dbSNP=TRUE, keepCOSMIC=TRUE,normalAD=normalAD,
  ...
  # LCML
    ...
    mafFiltered <- mutFilterCom(maf, VAF=0.2, Genomesprojects1000=TRUE,
                                dbSNP=dbSNP, tumorDP=tumorDP,normalAD=normalAD,
                                dbsnpCutoff=dbsnpCutoff, nonCutoff=nonCutoff,
                                normalDP=normalDP, tumorAD=tumorAD,
                                VAFratio=VAFratio, SBmethod=SBmethod,
                                SBscore=SBscore, maxIndelLen=maxIndelLen,
  ...
  # LIHC
    ...
    mafFiltered <- mutFilterCom(maf, tumorDP=15, normalDP=15, VAF=0.1,
                                ...
                                Genomesprojects1000=TRUE,normalAD=normalAD,
                                dbsnpCutoff=dbsnpCutoff, nonCutoff=nonCutoff,
                                tumorAD=tumorAD, keepType=keepType,
                                VAFratio=VAFratio, SBmethod=SBmethod,
                                SBscore=SBscore, maxIndelLen=maxIndelLen,
    ...
    mafFiltered <- mutFilterCom(maf, tumorDP=10, normalDP=8, VAF=0.01,
                                tumorAD=4, dbVAF=0.05, gnomAD=TRUE,
                                keepCOSMIC=TRUE, dbSNP=dbSNP, ExAC=TRUE,
                                Genomesprojects1000=TRUE,normalAD=normalAD,
                                dbsnpCutoff=19, nonCutoff=8,
                                keepType=keepType, SBmethod='SOR',
                                SBscore=3, VAFratio=VAFratio, 
