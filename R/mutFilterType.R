...
#' 
#' @return An MAF object after variant type filtering

mutFilterType <- function(maf, types = 'nonExomic') {
  ...
  maf_filtered <- data.frame(maf[which(!(maf$Variant_Classification %in% types)), ])
