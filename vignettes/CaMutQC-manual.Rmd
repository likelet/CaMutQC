...
### Multiple VCF
CaMutQC supports VEP annotated multi-sample or multi-caller VCF files as inputs, which should be under the same file path. **Supported caller: MuTect2, VarScan2, MuSE, Strelka2.**
...
MAFCom_tmb <- mutFilterCom(MAFdat, panel="WES", assay="Customized", report=FALSE, TMB=TRUE, 
                           ...
                           PONformat="txt", progressbar=TRUE, verbose=FALSE)
```
